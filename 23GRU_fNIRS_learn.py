...
model.add(layers.GRU(units=n_hidden, return_sequences=True, dropout=0.3))
model.add(layers.GRU(units=n_hidden, return_sequences=False, dropout=0.3))
...
weights_filepath = 'GRU_weights.keras'
